...
const handleShowPassword = useCallback((id) => {
  ...
  >
    ...
    <div className="w-full flex justify-center px-2 py-3 mt-2 bg-[rgba(255,255,255,0.1)] rounded-md">
        ...
        <TextInput 
          ...
          placeholder="Enter Password"/>
          {
            showPassword.password ?
              <EyeSlashIcon onClick={() =>handleShowPassword("password")} className="ml-3" width={24} color="white" />
            : <EyeIcon onClick={() =>handleShowPassword("password")} width={24} className="ml-3" color="white"/>
          }
    </div>
    <div className="w-full flex justify-center px-2 py-3 mt-2 bg-[rgba(255,255,255,0.1)] rounded-md">
        ...
        <TextInput 
          ...
          placeholder="Confirm Password"/>
          {
            showPassword.confirmPassword ?
              <EyeSlashIcon onClick={() =>handleShowPassword("confirmPassword")} className="ml-3" width={24} color="white" />
            : <EyeIcon onClick={() =>handleShowPassword("confirmPassword")} width={24} className="ml-3" color="white"/>
          }
    </div>
